...
class ST7735 {
 public:
  ...
  void drawHorizontalLine(uint8_t x0, uint8_t y0, uint8_t length, uint16_t color);
  void drawFastLine(uint8_t x0, uint8_t y0, uint8_t l, uint16_t color, uint8_t flag);
  ...
  void drawChar(uint8_t x, uint8_t y, char c,uint16_t color, uint8_t size=1);
  
  byte redrawChar(uint8_t x, uint8_t y, char c, uint16_t color, uint16_t background, uint8_t size=2);
  uint16_t modifyColor(uint16_t color, uint8_t size);

  static const uint8_t width = 160; //128;
  static const uint8_t height = 128; //160;
